...
photo_fundo = tk.PhotoImage(file = "C:/Users/Marcelo/Desktop/Python/MindMaster/ADVINHE_O_NÚMERO.png")
plano_fundo = tk.Label(janela, image = photo_fundo)
plano_fundo.place(x=0, y=0, relwidth=1, relheight=1)

nota = tk.Label(janela, text="", bg ="#F7F7F8", font=("Display", 15))
nota.grid(row=0, column=0)

menu()
palpite_jogador = tk.Label(janela, text="                    Digite um número de 4 dígitos entre 1000 e 9999 para tentar adivinhar:", bg ="#F7F7F8", font=("Arial", 15))
...
resultado = tk.Label(janela, text="", bg="#F7F7F8", font=("Arial", 15))
